const npm = {
    utils: require('spex/lib/utils'),
    batch: require('spex/lib/ext/batch'),
    page: require('spex/lib/ext/page'),
    sequence: require('spex/lib/ext/sequence'),
    stream: require('spex/lib/ext/stream'),
    errors: require('spex/lib/errors')
};
...
main.PromiseAdapter = require('spex/lib/adapter');
